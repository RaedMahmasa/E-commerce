                    ...
                    @foreach ($allproducts as $product )
                      ...
                      <div class="col-lg-4 col-sm-4" style="" >
                         <div class="box_main">
                            ...
                            <div class="tshirt_img"><img src="{{ asset('storage/'.$product->product_img) }}" style="max-height: 200px"></div>
                            <div class="btn_main">
                            ...
                            <div class="btn mx-3" style="background-color:#f1eaea;"><a href="{{ route('singleproduct',[$product->id,$product->slug]) }}">See More </a></div>
                                </form>
                            </div>
                         </div>
                      </div>
